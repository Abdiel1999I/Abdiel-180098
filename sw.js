...
//intalacion del ServiseW
self.addEventListener('install', result => {
    console.log("Servise Worker instalado")
    ...
    //todas las promesas esten dentro en una sola
    result.waitUntil(
        Promise.all([
            openStatic,
            openInmutable
...
self.addEventListener('activate', event => {
    ...
    console.log("Servise Worker activado")
